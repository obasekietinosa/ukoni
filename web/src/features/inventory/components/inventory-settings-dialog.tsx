          ...
          >
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                className="flex h-10 w-full rounded-lg border-none bg-slate-100 px-3 py-2 text-base md:text-sm ring-offset-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-electric-mint focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 transition-all duration-200"
              >
